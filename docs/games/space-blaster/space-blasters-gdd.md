...
**Space Blaster** is a modern, competitive reinterpretation of the classic _Space Invaders_ arcade formula.
...
> _Deliver a fast, accessible, and competitive arcade shooter that rewards mastery over time and encourages repeated play through leaderboard competition._
...
- Optimized for _instant play + repeated mastery_
