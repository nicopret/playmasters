...
> For MVP you _can_ run WebSockets inside the Next.js node runtime, but the clean long-term approach is a separate “realtime” app in Nx so it can scale and deploy independently.
