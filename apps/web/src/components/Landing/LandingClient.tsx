...
export function LandingClient({
  ...
  const carouselItems = (
    announcements.length ? announcements : fallbackAnnouncements
  ).map((item) => ({
    id: item.id,
    title: item.title,
    body: item.body,
        ...
        <Container>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.heading}>
              Arcade-grade cloud gaming, built for competition.
            </h2>
            <p className={styles.lead}>
              Pick a game, launch instantly, and climb the global ladder with
          ...
          <div className={styles.steps}>
            <div className={styles.stepCard}>
              ...
              <h3>Choose a game</h3>
              <p>
                Browse rotating arcade and creator-made titles curated for high
                replayability.
              </p>
            </div>
            <div className={styles.stepCard}>
              ...
              <p>
                Zero installs. Low-latency cloud sessions tuned for fast inputs
                and neon visuals.
              </p>
            </div>
            <div className={styles.stepCard}>
              ...
              <p>
                Submit runs, earn badges, and qualify for weekend finals with
                your crew.
              </p>
            </div>
          </div>
        ...
        <Container>
          <div className={styles.social}>
            <div>
              ...
              <p className={styles.lead}>
                Follow our drops, weekend events, and creator spotlights. Your
                squad is waiting.
              </p>
